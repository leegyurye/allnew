...
myframe.loc[myframe['국어'].isnull(), '국어'] = np.min(myframe['국어'].mean())
myframe.loc[myframe['영어'].isnull(), '영어'] = np.min(myframe['영어'].mean())
myframe.loc[myframe['수학'].isnull(), '수학'] = np.min(myframe['수학'].mean())
print(myframe)

print(np.round(myframe.describe()), 1)