...
SET DEFINE OFF;
Insert into HR.MEMBERTBL (MEMBERID,MEMBERNAME,MEMBERADDRESS) values ('Dang    ','당탕이  ','경기도 부천시 중동                    ');
Insert into HR.MEMBERTBL (MEMBERID,MEMBERNAME,MEMBERADDRESS) values ('Jee     ','지운이  ','서울 은평구 중산동                    ');
Insert into HR.MEMBERTBL (MEMBERID,MEMBERNAME,MEMBERADDRESS) values ('Han     ','한주연  ','인천 남주 주안동                     ');
